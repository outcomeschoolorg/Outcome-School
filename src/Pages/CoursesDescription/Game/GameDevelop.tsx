                ...
                <div className="container px-10 pt-[10em] py-10 mx-auto items-center justify-center h-auto">
                    ...
                    <div className=" mx-auto items-center flex flex-col md:flex-row gap-10   ">
                        <div className="md:w-1/2 items-center justify-center ">
                            ...
                            <div className=" leading-relaxed   ">
                                <p className="font-medium">
                                    <span className="text"> Goal: </span> Learn how games work and build small playable projects fast.
                                </p>
                                <p>
                                    ...
                                    <ul className="list-disc   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        ...
                                        <li>Basic physics & movement (jumping, acceleration, friction)</li>
                                        <li>Basic scripting/programming for gameplay</li>
                                        <li>Version control basics (Git) + teamwork basics</li>
                                    </ul>
                                </p>
                                <p className="my-5">
                                    <p className="font-medium  mb-3">Knowledge (what you understand)</p>
                                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        <li>   What makes a game “feel good”: responsiveness, feedback, timing, pacing</li>
                                        <li>Core design pillars: mechanics, dynamics, aesthetics</li>
                                ...
                                <div className="my-5">
                                    ...
                                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        <li className=""><span className="font-medium"> Weeks 1–3: </span> engine setup + core loop + input + movement</li>
                                        <li> <span className="font-medium">Weeks 4–6:</span> collisions + UI + audio feedback + simple enemies</li>
                                        <li><span className="font-medium">Weeks 7–9:</span> level design basics + progression + difficulty tuning</li>
                                        <li><span className="font-medium">Weeks 10–12:</span> polish sprint + publish-ready build + trailer</li>
                                    </ul>
                                </div>
                                ...
                                <div className="my-5">
                                    ...
                                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        <li className="">
                                            You can build a complete small game and publish a playable build.
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className="md:w-1/2  rounded-lg  mx-auto items-center">
                            <img src={two} alt="Programming" className=" object-cover w-[502px] lg:h-[602px] rounded-[20px] " />
