...
import one from "../../../assets/images/communication.png"
                    ...
                    <div className=" mx-auto items-center flex flex-col md:flex-row gap-10   ">
                        ...
                        <p className=" font-bold mb-3">Weeks 1–2</p>
                                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        <li>How recruiters evaluate communication </li>
                                        <li>Translating technical jargon into simple language</li>
                                        <li>Writing professional Slack updates and emails</li>
                                        <li>Explaining your project in 60 seconds</li>
                                        <li> <span className="font-medium">Deliverables:</span>   “About me” pitch + project explanation script + 1 polished written update.
                                        </li>
                                    </ul>
                                </p>
