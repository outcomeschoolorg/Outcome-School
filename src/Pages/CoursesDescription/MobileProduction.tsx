        ...
        <div className="container px-10 pt-[10em] py-10 mx-auto items-center justify-center h-auto">
          <div className="mb-14">
            <p className="text-black font-bold lg:font-extrabold text-[30px] lg:text-[45px] text-center ">
              Mobile + Production Engineering (Scale, Architecture, Real-World
              Readiness)
            </p>
          ...
          <div className=" mx-auto items-center flex flex-col md:flex-row gap-10   ">
            <div className="md:w-1/2 items-center justify-center ">
              <div className=" leading-relaxed   ">
                <p className="font-medium">
                  <span className="text"> Goal: </span> Build and ship mobile
                  apps + production-ready systems like an engineer.
                </p>
                ...
                <p>
                  ...
                  <ul className="list-disc   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                    <li>
                      {" "}
                      React Native (or Flutter if you prefer)
                    ...
                    <li className="ml-6 mt-2 space-y-1">
                      API integration: secure token storage, refresh tokens
                    </li>
                    <li className="ml-6 mt-2 space-y-1">
                      Mobile release basics: builds, app signing, store
                      submission overview
                    </li>
                  </ul>
                </p>
                ...
                <p className="my-3">
                  ...
                  <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                    ...
                    <li>
                      Architecture: clean folder structure, reusable services,
                      design patterns
                    </li>
                    <li>
                    ...
                    <li>
                      CI/CD basics: GitHub Actions, linting, test pipelines
                    </li>
                    <li>
                      Scaling fundamentals: background jobs/queues, websockets,
                      caching, CDN
                    </li>
                    <li>
                      Security: OWASP basics, secure auth flows, CORS, rate
                      limiting
                    </li>
                    <li>
                      Monitoring: logs, error tracking, performance monitoring
                    </li>
                  </ul>
                </p>
                <p className="">
                  <p className="font-medium  mb-3">
                    Expert capstone (must-have) Build a “real product” with web
                    + mobile:
                  </p>
                  <p className="font-regular">
                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                      ...
                      <li>
                        Backend API + Database (Node/Express or Next API routes)
                      </li>
                      <li>
                        Features:
                        <ul className="ml-3 list-dicsc">
                          ...
                          <li>
                            Payments or subscriptions (optional but powerful)
                          </li>
                ...
                <div className="my-3">
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      You can build, deploy, test, and maintain a web + mobile
                      product with professional practices.
                    </li>
                  </ul>
                </div>
                <div className="my-3">
                  <p className="font-medium mb-3">Suggested Tools by Level</p>
                  <ul className="ml-4 list-disc">
                    <li>
                      <strong>Level 1: </strong> VS Code, GitHub, Chrome
                      DevTools, Netlify
                    </li>

                    <li>
                      <strong>Level 2:</strong> React, Vite, React Router,
                      Tailwind/Bootstrap
                    </li>

                    <li>
                      <strong>Level 3:</strong> Node.js, Express, PostgreSQL,
                      Prisma, JWT, Docker (basic)
                    </li>

                    <li>
                      <strong>Level 4:</strong> React Native, TypeScript, CI/CD,
                ...
                <div className="my-3">
                  <p className="font-medium mb-3">
                    Minimum Portfolio (to look job-ready)
                  </p>
                  ...
                  <ul className="ml-4 list-decimal">
                    ...
                    <li>Full-stack CRUD app with auth + DB</li>
                    <li>Web + mobile capstone (deployed)</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-1/2  rounded-lg  mx-auto items-center">
              <img
                src={two}
                alt="Programming"
                className=" object-cover w-[502px] lg:h-[1002px] rounded-[20px] "
              />
            </div>
          </div>
        </div>
