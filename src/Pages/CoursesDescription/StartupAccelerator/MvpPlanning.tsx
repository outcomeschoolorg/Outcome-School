...
import one from "../../../assets/images/planning.png"
                    ...
                    <div className=" mx-auto items-center flex flex-col md:flex-row gap-10   ">
                        ...
                        <p className=" font-bold mb-3">Weeks 5–6</p>
                                    <ul className="list-decimal   font-regular lg:ml-5 mb-3 px-5 lg:px-0">
                                        <li>MVP scope + assumptions + risk reduction </li>
                                        <li>Build-measure-learn fundamentals</li>
                                        <li>Prototype testing and fast iteration</li>
                                        <li> <span className="font-medium">Deliverables:</span>  MVP spec, user journey, success metrics, v1 build plan, first onboarding script.
                                        </li>
                                    </ul>
                                </p>
