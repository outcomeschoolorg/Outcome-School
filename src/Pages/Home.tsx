  ...
  return (
    <>
      ...
      <div className="bg-white">
        <div className="container px-10 mx-auto items-center flex flex-col md:flex-row gap-10 min-h-screen ">
          <div className="md:w-1/2 text-white items-center justify-center ">
            <p className="leading-relaxed text text-[64px] mt-[2em] lg:mt-0 font-medium uppercase">
              Learn
            </p>
            <p className=" leading-relaxed uppercase text-[64px] text text-gray-300 mb-3 font-medium">
              By Doing
            </p>
      ...
      <div className="bg-[#8080801A]">
        <div className="container   mx-auto py-10">
          <div className="flex flex-col lg:flex-row mt-10 mx-auto items-center">
            <Link to="/donate">
              <div className="bg-[#8A38F5] rounded-[25px] h-[170px] lg:h-[350px] w-[290px] items-center pr-4 pt-4">
            ...
            <div className="flex flex-col lg:flex-row lg:gap-10 mt-10 mx-auto items-center">
              ...
              <div className="">
                ...
                <div
                  ...
                  className="bg-[#8A38F5] mb-5 rounded-[25px] h-[170px] w-[290px] flex flex-col items-center justify-center pr-4 pt-4 cursor-pointer hover:shadow-lg transition"
                >
                  <i className="fa-solid fa-arrow-up text-white float-right rotate-45 translate-y-1"></i>
              ...
              <div>
                ...
                <Link to="/aboutUs">
                  <div className="bg-[#8A38F5] mb-5 rounded-[25px] h-[170px] w-[290px] flex flex-col items-center justify-center pr-4 pt-4 cursor-pointer hover:shadow-lg transition">
                    <i className="fa-solid fa-arrow-up text-white float-right rotate-45 translate-y-1"></i>
      ...
      <div className="bg-[#5D7BF380] ">
        <div className="container flex flex-col py-10 gap-4 px-10 mx-auto items-center  ">
          <Link to="/application-process">
            <button
              type="button"
              className="background  rounded-[999px] py-6 px-10 mx-auto text-white font-semibold text-[16px]"
            >
          ...
          <Link to="/employer-partnerships">
            <button
              type="button"
              className="background rounded-[999px] py-6 px-9 mx-auto text-white font-semibold text-[16px]"
            >
              HIRE OUR GRADS
            </button>
          </Link>
      ...
      <div className="bg-white ">
        <div className="container flex flex-col py-10 gap-4 px-10 mx-auto items-center  ">
          <iframe
            height="315"
            className="rounded-lg my-5 lg:w-[60%]"
      ...
      <div className="bg-white ">
        <div className="container  py-10 gap-4 px-10 mx-auto items-center  ">
          ...
          {/* <marquee> */}
          <div className="flex gap-[6em] mt-10  text-center mx-auto items-center justify-center animate-marquee whitespace-nowrap">
